...
The next filter is a variance filter, selecting N genes from each data set with the largest dispersions. The value of N for each data set is determined based on the number of significantly differentially abundant features identified. 
