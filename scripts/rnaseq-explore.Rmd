...
invisible(capture.output(BPComBat(elist.w$E, batch=sample.table$batch, mod=design.NoTime, par.prior=TRUE, prior.plots = TRUE)))
```
...
invisible(BPComBat(elist.w$E, batch=sample.table$batch, mod=design.NoTime, par.prior=TRUE, prior.plots = TRUE))
invisible(dev.off())
```
...
elist.cb <- elist.w
elist.cb$E %<>% BPComBat(batch=sample.table$batch, mod=design.NoTime, par.prior=FALSE)
```
