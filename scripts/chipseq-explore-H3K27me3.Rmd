...
All the normalizations seem to perform very similarly here except for the loess normalization, which results in much a larger prior d.f. For this reason, we are incluned to distrust the loess normalization.
