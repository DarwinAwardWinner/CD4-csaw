...
knitr::opts_chunk$set(echo = TRUE, retina=2, cache=TRUE, autodep=TRUE,
                      ...
                      cache.path = paste0(
                          here::here("cache", "peak-cpg-figure7"),
                          .Platform$file.sep))
```
...
The next filter is a variance filter, selecting N genes/peaks from each data set with the largest dispersions. The value of N for each data set is determined based on the number of significantly differentially abundant features identified.
