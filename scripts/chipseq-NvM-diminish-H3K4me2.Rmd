...
This analysis doesn't support a hypothesis of monotonically diminishing differences between cell types, but it does imply that there are minimal differences in the last time point.
