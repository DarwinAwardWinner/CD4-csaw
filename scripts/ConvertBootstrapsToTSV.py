...
# Script downloaded and adapted from:
# https://raw.githubusercontent.com/COMBINE-lab/salmon/master/scripts/ConvertBootstrapsToTSV.py
...
def main(args):
    ...
    with gzip.open(nameFile) as nf:
        txpNames = nf.read().strip().decode('utf8').split('\t')
