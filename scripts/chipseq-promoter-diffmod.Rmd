...
sexpfile <-
    file.path(params$basedir, "saved_data",
              glue_data(params, "promoter-counts_{genome}_{transcriptome}_{promoter_radius}-radius_147bp-reads_{histone_mark}.RDS"))
...
saveRDS(results.tables,
    file.path(params$basedir, 'saved_data', 'ChIP-seq',
        glue_data(params, '{genome}_{transcriptome}_{histone_mark}-{promoter_radius}-promoter-diffmod.RDS')))
save.image(file.path(params$basedir, 'saved_data', 'ChIP-seq',
...
write.xlsx(filtered.results.tables,
    file.path(params$basedir, "results", "ChIP-seq",
