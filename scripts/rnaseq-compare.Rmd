...
* STAR vs HISAT2
* STAR vs Salmon (with and without offset)
* Salmon vs Kallisto (with and without offset)
* Salmon vs shoal

Plots to make:

* Abundance A vs B w/correlation
* Plot of estimated length A vs B (where relevant)
