...
pnf %<-% normOffsets(nhood_sexp, type = "scaling", weighted = TRUE)
wnf %<-% normOffsets(sexp, type = "scaling", weighted = TRUE)
loff %<-% { normOffsets(nhood_sexp, type = "loess") + mean(getOffset(dge)) }
